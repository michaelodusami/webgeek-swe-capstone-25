...
excluded_directories = {".git", "__pycache__", ".vscode", ".idea", ".DS_Store", "node_modules", "build", "dist", ".venv", ".cursor", ".pytest_cache"} # Directories to ignore
excluded_file_extensions = {
    "png", "jpg", "jpeg", "gif", "ico", "svg", "pdf", "zip", "tar", "gz", "rar",
    "bin", "dylib", "so", "o", "a", "pyc", "DS_Store",  # Binary/compiled files
    "log", "tmp", "sh", "md", "Dockerfile", "docker-compose.yml", "db", "log"  # Common temporary/log files
